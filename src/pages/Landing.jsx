  ...
  return (
    <div className="bg-[#050505] text-white overflow-x-hidden">
      ...
      <section className="min-h-screen flex items-center justify-center pt-16 px-6">
        <div className="max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              onClick={goSignup}
              className="px-12 py-6 text-lg font-semibold rounded-2xl bg-gradient-to-r from-[#67e8f9] to-[#ec4899] text-black hover:bg-white transition"
            >
              Get Started
            </button>
            <button 
              onClick={goLogin}
              className="px-12 py-6 text-lg font-semibold rounded-2xl border border-white/30 hover:bg-white/10 transition"
            >
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <div key={item.title} className="p-10 rounded-3xl border border-white/10 hover:border-[#67e8f9] transition bg-zinc-950">
      ...
      <section className="py-32 text-center border-t border-white/10 px-6">
        ...
        <button
          onClick={goSignup}
          className="px-16 py-7 text-2xl font-semibold rounded-3xl bg-white text-black hover:bg-gradient-to-r hover:from-[#67e8f9] hover:to-[#ec4899] hover:text-white transition-all"
        >
          Join SyncUp Now →
        </button>
      </section>
